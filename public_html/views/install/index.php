    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <?php if ($success): ?>
            <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded">
                <h4 class="font-bold"><?= t('install.complete') ?></h4>
                <p><?= t('install.complete_help') ?></p>
                <div class="mt-4">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input id="username" 
                               ...
                               placeholder="<?= htmlspecialchars(t('install.username_ph')) ?>">
                    </div>
                    ...
                    <div>
                        ...
                        <input id="email" 
                               ...
                               required 
                               class="mt-1 appearance-none relative block w-full px-4 py-3 border-2 border-gray-300 placeholder-gray-500 text-gray-900 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm bg-white"
                               placeholder="<?= htmlspecialchars(t('install.email_ph')) ?>">
                    </div>
