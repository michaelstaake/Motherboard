<div class="px-6 py-4">
    <div class="flex justify-end mb-6">
        <button type="button" onclick="showCreateModal()" class="inline-flex items-center justify-center rounded-md border border-transparent bg-primary-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
            <?= t('users.add') ?>
        </button>
    </div>
